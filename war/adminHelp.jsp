...
<title>Picture Box - Admin Help</title>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
          <div class="jumbotron">
              <h1>Hello, Admin!</h1>
              <p>This help page is here to assist you Administrating Picture Box.
                As an Admin you can view private and public images and upload your own images, which can be made private or public (default private).
                You can also Modify all of the images on Picture Box.</p>
            </div>
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                As an Admin, you may view both private and public images.
             ...
             <div class="panel panel-danger">
              ...
              <div class="panel panel-danger">
               <div class="panel-heading">
                <h3 class="panel-title">Modifying User Images (Deleting/Changing Visibility)</h3>
              </div>
              <div class="panel-body">
                Modifying a User image is the same as modifying your own image (as detailed in the previous panel),
                With the only difference being, it is done through the "Admin Panel" link in the nav bar.
                This is the same as your "My Images" page but contains all of the images on Picture Box.
                Please remember...
                <center><img class="img-responsive" src="/img/wgpcgr.png" alt="dumb spiderman quote missing! everyone panic!"></center>
              </div>
         </div>
              <!-- Footer -->
            <footer>
